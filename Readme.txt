...
Game is lost when one gets a suspicion level of 100% or falls off the highline
Game is won when the player reaches the end
The score is calculated by time taken * (meal swipes left * 0.1 + 1) - suspicion * 10

Read more about this project at https://shantanubhatia.wordpress.com/2017/03/13/super-highline-bros/
